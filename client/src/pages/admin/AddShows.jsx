...
const AddShows = () => {
  ...
  return nowPlayingMovies.length> 0 ? (
    <>
      <Title text1="Añadir" text2="Películas"/>
      <p className='mt-10 text-lg font-medium'>Películas en Cartelera</p>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
          ...
          <input min={0} type="number" value={showPrice} onChange={(e) => setShowPrice(e.target.value)} placeholder="Ingresar precio de la entrada" className="outline-none" />
        </div>
      </div>

      {/* Date & Time Selection */}
      <div className="mt-6">
        <label className="block text-sm font-medium mb-2">Seleccionar Hora y Fecha</ label>
